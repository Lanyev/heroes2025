/**
 * Diccionario de frases chuscas para los diferentes tipos de highlights de jugadores
 * Nivel: humor gamer, sarcasmo y roast ligero
 */
export const PLAYER_HIGHLIGHTS_JOKES = {
  ...
  generic_matches: [
    ...
    'Claramente te gusta jugar.',
    'La constancia también cuenta.',
    'Horas de tu vida bien invertidas… supongo.',
    'Este juego ya paga renta.',
    'Se nota el compromiso.',
    'Aquí hubo dedicación.',
    'Este jugador no fue casualidad.',
    'El jugador favorito no se niega.',
  ],
...
export function getRandomJoke(highlightType) {
  const jokes = PLAYER_HIGHLIGHTS_JOKES[highlightType];
